...
public class COSProvider {
    ...
    private String secretId = "AKIDPdYFhv3eBVamjRqAC1c4bw3MQFpFokod";
    private String secretKey = "xf9NN8sQjogKjvsqeHCvQhlatxqUt3yf";
...
// clientConfig 中包含了设置 region, https(默认 http), 超时, 代理等 set 方法, 使用可参见源码或者常见问题 Java SDK 部分。
    ...
    public String COSUpload(File file, String fileName) {
        logger.info("upload");
        // 指定要上传的文件
        File localFile = file;
// 指定要上传到的存储桶
...
// 指定要上传到 COS 上对象键
        ...
        return "https://images-1300052406.cos.ap-shanghai.myqcloud.com/" + key;
    }
}
